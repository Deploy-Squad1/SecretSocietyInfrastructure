...
module "eks" {
  ...
  access_entries = {
    ...
    admin_host = {
      principal_arn = "arn:aws:iam::963947738852:role/admin-ssm-role-prod"
    ...
    terraform = {
      principal_arn = "arn:aws:iam::963947738852:role/TerraformDeployRole"
    ...
    jenkins = {
      principal_arn = "arn:aws:iam::963947738852:role/jenkins-ssm-role-prod"
